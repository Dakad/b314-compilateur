...
public class B314instr_if_then_elseSemanticOkTest {

    private static final Logger LOG = LoggerFactory.getLogger(B314instr_if_then_elseSemanticOkTest.class);
    ...
    @Test
    public void testinstr_if_then_else_op_var_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/semantics/instr_if_then_else/ok/op_var.b314", testFolder.newFile(), true, "instr_if_then_else: op_var");
    }
    ...
    @Test
    public void testinstr_if_then_else_var_ok() throws Exception{
        CompilerTestHelper.launchCompilation("/semantics/instr_if_then_else/ok/var.b314", testFolder.newFile(), true, "instr_if_then_else: var");
    }
